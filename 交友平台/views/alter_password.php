...
$dbusername = null; 
$dbpassword = null; 
$result = mysqli_query($con , "SELECT * FROM login_info where username ='$username' AND email='$email';" ); 
...
mysqli_query ($con , "UPDATE login_info set password='$newpassword_1' where username='$username'AND email='$email'" ) or die ( "存入資料庫失敗" . mysqli_error ($con) );//如果上述使用者名稱密碼判定不錯，則update進資料庫中 
mysqli_close ( $con ); 
